            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md4">
                    <div class="form-group">
                        ...
                        <input type="text" id="cel" name="nrcel" class="form-control" placeholder="Celular" value="<?php echo htmlspecialchars( $user["nrcel"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                    </div></div>  
            </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <select name="desprofile" id="profile" class="form-control"></select>
                    </div>
                </div> 
                <div class="col-lg-4">
                    <div class="form-group">
