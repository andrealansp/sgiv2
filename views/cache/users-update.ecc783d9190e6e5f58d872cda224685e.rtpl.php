...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
        <form action="/users/<?php echo htmlspecialchars( $user["idusuarios"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post" >
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <select name="desperfil" id="profile" class="form-control"></select>
                    </div>
                </div> 
                <div class="col-lg-4">
                    <div class="form-group">
