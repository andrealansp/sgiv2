    ...
    <table class="table table-hover" id="tb-users">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="/users/update/<?php echo htmlspecialchars( $value1["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-success">Editar</a> / <a href="/users/del/<?php echo htmlspecialchars( $value1["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-danger">Deletar</a></td>
        </tr>
        <?php } ?>
      </tbody>
    </table>
